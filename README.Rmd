...
- [Comparing CellChat and CellPhoneDB results](https://github.com/nigelhojinker/CCCtools/blob/main/data-raw/Crosscheck.md)
...
The mapped databases of CellPhoneDB (v5) and CellChat (v2) and are available by running `data(CPDB)` and `data(CCDB)` respectively. These databases will be used in the `crosscheck()` function after users have ran both CellPhoneDB and CellChat on their dataset, and would like to find out which interactions have been identified by both tools.
