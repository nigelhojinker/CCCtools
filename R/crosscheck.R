...
#'
#' @returns A list of five elements: (1) Comparative analysis result (2) 2x2 contingency table of interaction types in both CellChat and CellPhoneDB (3) Number of significant interactions from both analyses (4) Jaccard Index for significant interactions inferred (5) Matthew's Correlation Coefficient to quantify agreement
#' @export
#'
#' @examples
#' \dontrun{
