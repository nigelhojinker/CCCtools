...
a list of two elements: (1) Comparative analysis result (2) 3x3
contingency table of interaction types in both CellChat and CellPhoneDB.
We categorise interactions in the filtered result in terms of the
agreement (and lack thereof) between CellChat and CellPhoneDB as such:
